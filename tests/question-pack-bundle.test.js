...
test('content catalog replaces fourteen parser-blocking pack requests with one bundle', () => {
  ...
  for (const file of ['question-pack-02.js', 'question-pack-transfer-07.js', 'question-pack-fill-01.js', 'question-pack-reorder-01.js']) {
...
test('browser bundle exposes every reviewed pack before the catalog assembles questions', () => {
  ...
  assert.equal(context.window.ManjingoContent.questions.length, 557);
