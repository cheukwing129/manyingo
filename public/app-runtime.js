...
'use strict';
const state={active:false,rendered:false,page:'home',targeted:false,remedial:false,reteach:false,kpId:null,answered:0,correct:0,xp:0,resolved:new Set(),startMastery:new Map(),startStages:new Set()};
...
const api={clean,parseXp,deltaText,recommend,model,markup,render,reset,snapshot,masteryDelta,newStages,countFeedback,questionFor,remedialOnPage,reteachOnPage,celebrationCopy,mascotRuntime,mascotState,mascotAsset,MASCOT_ASSETS,FALLBACK_MASCOT_ASSETS,install,observer:null};
if(typeof document!=='undefined'){if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',install);else install()}
return api;
});
;
