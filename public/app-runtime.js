...
const api={clean,parseXp,deltaText,progressSignal,misconceptionWeight,persistentWrongSignal,recommend,model,markup,render,reset,snapshot,masteryDelta,newStages,countFeedback,questionFor,remedialOnPage,reteachOnPage,celebrationCopy,mascotRuntime,mascotState,mascotAsset,MASCOT_ASSETS,FALLBACK_MASCOT_ASSETS,install,observer:null};
if(typeof document!=='undefined'){if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',install);else install()}
return api;
});
;
